...
///------------
/// Center Border + Offsets
///------------


-(void)addCenterHorizontalseparatorWithHeight:(CGFloat)height color:(UIColor*)color leftOffset:(CGFloat)leftOffset topCenterWidth:(CGFloat)centerOffset andRightOffset:(CGFloat)rightOffset;
