...
@interface LBorderView : CustomBtn {
...
@property (strong, nonatomic) NSString *positionCode;
@property (assign, nonatomic) BOOL showChartingBorder;

@property (nonatomic, weak) UIView *relatedControl;
