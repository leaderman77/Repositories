...
//    __block UIActivityIndicatorView *preloader = [[UIActivityIndicatorView alloc] initWithFrame:CGRectMake(0.f, 0.f, 10.f, 10.f)];
//    preloader.activityIndicatorViewStyle = UIActivityIndicatorViewStyleWhite;
...
//    [self addSubview:preloader];
    ...
    if ([self viewWithTag:PRELOADER_TAG] == nil) {
        __block UIActivityIndicatorView *preloader = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
        preloader.top = 0.5 * (self.height - preloader.height);
        preloader.left = 0.5 * (self.width - preloader.width);
        preloader.tag = PRELOADER_TAG;
        [preloader startAnimating];
        [self addSubview:preloader];
    }
    ...
    id <SDWebImageOperation> operation = [SDWebImageManager.sharedManager downloadImageWithURL:url options:options progress:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
        ...
        dispatch_main_sync_safe(^{
            ...
            [[sself viewWithTag:PRELOADER_TAG] removeFromSuperview];
